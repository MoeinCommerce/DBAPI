...
namespace DatabaseApi.Contexts.Interfaces
{
    public interface IDbContext : IDisposable
    {
        ...
        List<(int WarehouseId, double Stock)> GetProductStocksByWarehouseIds(string productId, List<int> warehouseIds);
        ...
        List<int> GetCollectionAttributeValueIds(string attributeId, string attributeValueId, int targetWeb);
        List<int> GetCollectionProductAttributeValueIds(string attributeValueId, int targetWeb);
        bool AttributeExists(string name, List<string> ignoreNames = null);
        string CreateAttribute(AttributeModel attribute);
        string CreateAttributeValue(AttributeValueModel attributeValue);
        bool AttributeValueExists(string attributeId, string value, List<string> ignoreValues = null);
        List<AttributeValueModel> GetAttributeValuesByAttributeId(string attributeId);
        bool IsAttributeValueUsedInCollection(string attributeId, string attributeValueId, int targetWeb);
        bool IsAttributeValueUsedInCollectionProduct(string attributeValueId, int targetWeb);
        void UpdateAttributeById(string attributeId, AttributeModel attribute);
        void UpdateAttributeValueById(string attributeValueId, AttributeValueModel attributeValue);
        void DeleteAttributeValueById(string attributeValueId);
        List<AttributeModel> GetAttributes();
        List<AttributeValueModel> GetAttributeValues();
        bool IsAttributeUsedInCollectionProduct(string attributeId, int targetWeb);
        void DeleteAttributeValueByAttributeId(string attributeId);
        ...
        bool CollectionAttributeValueExists(int collectionAttributeId, string valueId, int targetWebId);
        void UpdateCollection(string collectionId, CollectionModel collection, int targetWebId);
        void DeleteCollectionAttributeValuesByCollectionAndAttributeId(string collectionId, string attributeId, int targetWebId);
        void DeleteCollectionAttributeValuesByValueId(int collectionAttributeId, string valueId, int targetWebId);
        void DeleteCollectionAttributesByCollectionAndAttributeId(string collectionId, string attributeId, int targetWebId);
        List<CollectionAttributeModel> GetCollectionAttributesByCollectionAndAttributeId(string collectionId, string attributeId, int targetWebId);
        bool CollectionAttributeExists(string collectionId, string attributeId, int targetWebId);
